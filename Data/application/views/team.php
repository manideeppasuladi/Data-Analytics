...
.industry .card {
 ...
 <div class="container pt-5 pb-5" id="organisingBody">
        ...
        <div class="row justify-content-center align-items-center text-center">
        <div class="col-sm-12 col-md-6 col-lg-4 mb-2 hvr-shadow-radial" >
              <h2 class="h3-responsive font-weight-bold text-center mb-5 pt-5 wow fadeInUp">INDUSTRY ASSOCIATION</h2>
        </div>
        <div class="col-sm-12 col-md-6 col-lg-4 mb-2 hvr-shadow-radial" >
              <h2 class="h3-responsive font-weight-bold text-center mb-5 pt-5 wow fadeInUp">INDUSTRY EXPERT</h2>
        </div>
        </div>
