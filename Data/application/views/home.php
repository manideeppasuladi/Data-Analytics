...
<section class="mt-5 wow fadeIn" id="about">
  ...
  <div class="row justify-content-center align-items-center  justify-content-center align-items-center" >
    ...
    <div class="col-md-6 mb-4 mx-auto ">
      ...
      <img src="https://progressive.in/wp-content/uploads/2018/01/big-data.png" class="img-fluid "
        alt="Not available">
...
<div class="col-md-6 mb-4 mx-auto ">
  ...
  <img src="http://houseofbots.com/images/news/2895/cover.png" class="img-fluid"
    alt="Not available">
...
<!--Section: Activities-->
  ...
  <div class="row justify-content-center text-center">
      <div class="contact text-light">
        ...
        <div class="divider pt-3 pb-1"></div>
        <a href="<?php echo base_url(); ?>index.php/Contact" class="btn btn-primary waves-effect text-light"> GET IN TOUCH! </a>
      </div>
  </div>
  </div>
  </section>
